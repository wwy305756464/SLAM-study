...
int main(int argc, char **argv) {
	...
	if (!fin) {
		cerr << "Please run this program in folder with pose.txt" << endl;
		return 1;
	}
	...
	// vector::reserve(n) -> request the vector capacity be at least enough to contain n elements.

	for (int i = 0; i < 5; ++i) {
		cout << "tranfering image: " << i + 1 << endl;
	...
	cout << "pointcloud totally has " << pointcloud.size() << "points" << endl;
